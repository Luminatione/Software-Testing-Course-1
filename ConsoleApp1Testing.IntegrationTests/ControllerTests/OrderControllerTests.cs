    ...
    public class OrderControllerTests
    {
        ...
        public void CreateOrder_ValidClientAndProducts_AddsOrder()
        {
            ...
            var orderController = new OrderController(orderRepositoryMock.Object, clientRepositoryMock.Object,
                                                    productRepositoryMock.Object, databaseServiceMock.Object);
            ...
            // Assert
            databaseServiceMock.Verify(db => db.AddOrder(It.IsAny<Order>()), Times.Once);
        }
        ...
        public void CreateOrder_InvalidClient_ThrowsArgumentException()
        {
            ...
            // Act and Assert
            Xunit.Assert.Throws<ArgumentException>(() => orderController.CreateOrder(clientId, productList));
        }
        ...
        public void CreateOrder_InvalidProduct_ThrowsArgumentException()
        {
            ...
            // Act and Assert
            Xunit.Assert.Throws<ArgumentException>(() => orderController.CreateOrder(clientId, new List<Product> { product }));
        }
    }
}
